...
class WeightDistributionMinimumCompliance(Problem):
    ...
    GPU-accelerated version of WeightDistributionMinimumCompliance. Extends MinimumCompliance
    with an additional constraint on the centroid location of the material distribution.
    Useful for balancing structures or controlling center of mass for dynamic applications.
    All computations performed on GPU using CuPy.
    ...
    **GPU Acceleration:**
    ...
    - 5-10x faster than CPU for large problems
